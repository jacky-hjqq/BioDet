...
class Detections:
    ...
    def save_to_file(
        ...
        if dataset_name == "xyzibd":
            # Convert object_ids to xyzibd format
            self.object_ids = xyzibd_object_ids[self.object_ids]
        elif dataset_name == "ipd":
            # Convert object_ids to ipd format
            self.object_ids = ipd_object_ids[self.object_ids]
        elif dataset_name == "itodd":
            # Convert object_ids to itodd format
