...
class GroundingDINO(nn.Module):
    ...
    def __init__(
        ...
        self.tokenizer = BertTokenizerFast.from_pretrained("robokit/cfg/gdino/bert-base-uncased", local_files_only=True)
        self.bert = BertModel.from_pretrained(pretrained_model_name_or_path="robokit/cfg/gdino/bert-base-uncased", local_files_only=True)
